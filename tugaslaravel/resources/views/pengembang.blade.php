    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h1 style="font-family: Arial, Helvetica, sans-serif;">Data Karyawan Divisi Pengembang</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <table class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                        @foreach($pekerja as $tampil)
                            <td>{{ $tampil }}</td>
                        @endforeach
                      </tr>
                      <tr>
                        @foreach($pekerja2 as $muncul)
                            <td>{{ $muncul }}</td>
                        @endforeach
                      </tr>
                      <tr>
                        @foreach($pekerja3 as $hadir)
                            <td>{{ $hadir }}</td>
                        @endforeach
                      </tr>
                    </tbody>
